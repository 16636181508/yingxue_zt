...
<head>
    ...
    <script type="text/javascript">
        function changeCode() {
            /*根据id获取*/
            $("#captchaImage").prop("src","${pageContext.request.contextPath}/user/getImageCode?xx"+Math.random());
        }
    </script>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-6 col-sm-offset-3 form-box">
                    ...
                    <span><font style="color: red">${requestScope.message}</font></span>
                    <div class="form-bottom" style="width: 450px">
                        <form role="form" action="${pageContext.request.contextPath}/user/login" method="post" class="login-form" id="loginForm">
                            <span id="msgDiv"></span>
                            <div class="form-group">
                                <label class="sr-only" for="form-username">Username</label>
                                <input type="text" minlength="5" name="name" placeholder="请输入用户名..." class="form-username form-control" required id="form-username">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <img id="captchaImage" style="height: 48px" class="captchaImage" src="${path}/user/getImageCode" onclick="changeCode()">
