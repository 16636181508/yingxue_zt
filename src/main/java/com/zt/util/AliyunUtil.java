...
public class AliyunUtil {
    ...
    //说明 有备注无需修改的位置请勿改动
     static SendSmsResponse queryPhone(String phoneNumbers,String signName,String templateCode,String templateParam )throws Exception{
        ...
        //替换成你的AK
        final String accessKeyId = "LTAI4GDnLWhkbWY85PLicErQ";//你的accessKeyId,参考本文档步骤2
        final String accessKeySecret = "swwTxaZUfKTl8UQY2DLYcqwXj1qCv4";//你的accessKeySecret，参考本文档步骤2
   ...
   public static String sendPhoneMsg(String phoneNumbers,String code){
        ...
        try {
            ...
            String signName="海绵课堂";
            String templateCode= "SMS_205616570";
    ...
    public static void main(String[] args) {
        String phoneNumbers="17835364326";
